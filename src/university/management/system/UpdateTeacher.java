...
public class UpdateTeacher extends JFrame implements ActionListener {
    ...
    JLabel lblrollnumber=new JLabel("Select By empID");
    ...
    labelempid.setBounds(150,200,150,30);
    ...
    try{
       ...
       Conn c = new Conn();
            ...
            if (rs.next()) {
                ...
                tfcourse.setText(rs.getString("eduction"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            String query="update teacher set adderss='"+adderss+"',phone='"+phone+"',email='"+email+"',eduction='"+course+"',department='"+branch+"' where empID='"+empid+"'";
            Conn con=new Conn();
