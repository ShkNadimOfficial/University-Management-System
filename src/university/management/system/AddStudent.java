...
public class AddStudent extends JFrame implements ActionListener {
    ...
    //text frollno
    tfrollno=new JLabel("1533"+firstfour);
    tfrollno.setBounds(150,200,150,30);
    tfrollno.setFont(new Font("serif",Font.BOLD,20));
    add(tfrollno);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"Students Details inserted Sucessfully...");
            setVisible(false);
